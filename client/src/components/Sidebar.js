    ...
    return (
        <div>
            <div className='lg:hidden'>
                <Transition show={sidebar} className="fixed inset-0 flex z-40">
                    ...
                    <Transition.Child
                        ...
                        className="relative flex-1 flex flex-col max-w-xs w-full py-4 bg-gray-100"
                    >
                            ...
                            <nav className="px-2">
                                <div className="space-y-1">
                                    ...
                                    <NavLink to="/dashboard"
                                             className="bg-gray-200 text-gray-900 group flex items-center px-2 py-2 text-base leading-5 font-medium rounded-md"
                                             aria-current="page">
                                        {/*// <!-- Current: "text-gray-500", Default: "text-gray-400 group-hover:text-gray-500" -->*/}
                                        <svg className="text-gray-500 mr-3 h-6 w-6"
                                ...
                                <div className="mt-8">
                                    ...
                                    <div className="mt-1 space-y-1" role="group" aria-labelledby="teams-headline">
                                        {teams.map(team => {
                                            return (
                                                <NavLink to={`/teams/${team.name.toLowerCase()}`} key={team._id}
            ...
            <div className="hidden lg:flex lg:flex-shrink-0">
                <div className="flex flex-col w-64 border-r border-gray-200 py-4 bg-gray-100 min-h-screen">
                        ...
                        <nav className="px-3 mt-5">
                            <div className="space-y-1">
                                ...
                                <NavLink to="/dashboard"
                                    ...
                                    {/*// <!-- Current: "text-gray-500", Default: "text-gray-400 group-hover:text-gray-500" -->*/}
                                    <svg className="text-gray-500 mr-3 h-6 w-6" xmlns="http://www.w3.org/2000/svg"
